 ...
 */
public class MOEADRunnerMultiPharm extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    algorithm = new MOEADBuilder(problem, MOEADBuilder.Variant.MOEADOptiPharm)
    ...
    String[] temp = MultiPharm.queryPath.split(".+?/(?=[^/]+$)");
    String queryBasename = (temp[temp.length-1].split("\\.(?=[^\\.]+$)"))[0];
    String[] temp2 = MultiPharm.targetPath.split(".+?/(?=[^/]+$)");

 ...
 */
public class MOEADRunnerMultiPharmOE extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    JMetalLogger.logger.info("Run MOEAD");
    ...
    JMetalLogger.logger.info("Total execution time of "+targetName+": " + computingTime + "ms");
    System.out.println("Total execution time of "+targetName+": " + computingTime + "ms");

    //printFinalSolutionSet(population);
    //printFinalSolutionSet(population, algorithm.getName());
    String folderName = algorithm.getName()+queryName;
    printFinalSolutionSet(population, folderName, targetName);
